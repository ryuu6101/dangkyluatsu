...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('documents', function (Blueprint $table) {
            ...
            $table->date('union_joining_date')->nullable();
            $table->date('vcp_temperary_date')->nullable();
            $table->date('vcp_offical_date')->nullable();
            $table->string('law_certificate_number')->nullable();
            $table->date('law_certificate_date')->nullable();
            $table->date('first_time_join')->nullable();
            $table->string('law_degree_number')->nullable();
            $table->date('law_degree_date')->nullable();
            $table->string('law_degree_place')->nullable();
            $table->string('graduate_degree_number')->nullable();
            $table->date('graduate_degree_date')->nullable();
