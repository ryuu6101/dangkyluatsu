        ...
        <div class="card pt-3 px-4" style="background-color: rgba(255,255,255,0.7)">
            <div class="wizard-progress mb-4">
                ...
                <div class="step {{ $progress->current_step > $sn ? 'complete' : ''}}">
                    ...
                    Đoàn ra nghị quyết, kèm Danh sách
                </div>
                @php($sn++)
                <div class="step {{ $progress->current_step > $sn ? 'complete' : ''}}">
                    <div class="node">
            ...
            <div class="wizard-vertical px-4 mb-4">
                ...
                <div class="step {{ $progress->current_step > $sn ? 'complete' : ''}}">
                    ...
                    <div class="step-content">
                        ...
                        @else
                        <a href="#!" class="badge badge-white border rounded-pill ml-2">Lập giấy tại đây</a> <br>
                        @endif
                ...
                <div class="step {{ $progress->current_step > $sn ? 'complete' : ''}}">
                    ...
                    <div class="step-content">
                        ...
                        <a href="#!" class="badge badge-white rounded-pill ml-2">Nộp tiền</a>
                        @else
                ...
                <div class="step {{ $progress->current_step > $sn ? 'complete' : ''}}">
                    ...
                    <div class="step-content">
                        ...
                        <span class="badge badge-light border text-muted rounded-pill ml-2">Chưa trả</span> <br>
