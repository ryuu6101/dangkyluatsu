<div class="form-container">
    ...
    <div class="row mb-2">
        <div class="col-auto">Thẻ luật sư số:</div>
        <div class="col field">{{ $document->lawyer_card_number }}</div>
        <div class="col-auto">do Liên đoàn luật sư Việt Nam cấp ngày</div>
        <div class="col field">{{ $document->lawyer_card_date }}</div>
    </div>

    <div class="row mb-2">
        <div class="col-auto">Lý do xin đổi thẻ luật sư:</div>
        <div class="col field">{{ $document->card_exchange_reason }}</div>
    </div>
