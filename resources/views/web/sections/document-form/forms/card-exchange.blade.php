    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body document-form" style="padding: 1.25rem 5rem">
                <input type="hidden" name="secondary_form[document_type_id]" value="4" form="memberRegisterForm">
                <div class="row">
                    <div class="col">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-auto">
                        <strong> do Liên đoàn luật sư Việt Nam cấp ngày</strong>
                    </div>
                    <div class="col">
                        <input type="text" class="dotted-line-input datepicker" 
                        placeholder="DD/MM/YYYY" name="secondary_form[lawyer_card_date]" form="memberRegisterForm">
                        <span class="error-message text-danger"></span>
                ...
                <div class="row mb-2">
                    <div class="col-auto">
                        <strong>{{ $sn++ }}. Lý do xin đổi thẻ luật sư: </strong>
                    </div>
                    <div class="col">
                        <input type="text" class="dotted-line-input" 
                        name="secondary_form[card_exchange_reason]" form="memberRegisterForm">
                        <span class="error-message text-danger"></span>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered mt-2" style="font-weight: 600">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-left">Thẻ luật sư (Bản sao) (không bắt buộc)</td>
                                    <td class="text-center">
                                        <input type="hidden" name="secondary_form[attachments][1][name]" 
                                        value="Thẻ luật sư (Bản sao) (không bắt buộc)" form="memberRegisterForm">
                                        <input type="file" name="secondary_form[attachments][1][files][]" class="d-none attachment-files" 
                                        multiple id="secondary_attachment_files_1" form="memberRegisterForm">
                                        <label type="button" class="m-0" for="secondary_attachment_files_1">
...
<script>
    ...
    function openSecondaryForm(formId) {
        ...
        if (!notified) {
            notified = true;
            new Noty({
                text: 'Vì bạn là luật sư chuyển từ đoàn khác về nên cần điền thêm đơn xin đổi thẻ luật sư',
                type: 'success',
            }).show();
        }
    }
